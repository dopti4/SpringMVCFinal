	...
	<div class="container mt-5 text-center">
		<div class="row">
			...
			<form action="./main_page.do" method="get">
				...
				<div class="row mt-3">	<!-- 페이지 버튼 -->
					<div class="col">
						<nav aria-label="Page navigation example">
						  <ul class="pagination">
						  
						  	<li class="page-item<c:if test="${beginPage-1 <= 0 }"> disabled</c:if>"><a class="page-link" href="${pageContext.request.contextPath }/board/main_page.do?currentPage=${beginPage-1}&search_word=${param.search_word}">Previous</a></li>
						  	<c:forEach begin="${beginPage }" end="${endPage }" var="i">
						  		<li class="page-item<c:if test="${currentPage == i }"> active</c:if>"><a class="page-link" href="${pageContext.request.contextPath }/board/main_page.do?currentPage=${i}&search_word=${param.search_word}">${i }</a></li>
						  	</c:forEach>
						  	<li class="page-item<c:if test="${endPage+1 > (totalCount-1)/10+1 }"> disabled</c:if>"><a class="page-link" href="${pageContext.request.contextPath }/board/main_page.do?currentPage=${endPage+1}&search_word=${param.search_word}">Next</a></li>
						  	
						  <!-- 
						    <li class="page-item disabled"><a class="page-link" href="#">Previous</a></li>
						    <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath }/board/main_page.do?currentPage=1">1</a></li>
